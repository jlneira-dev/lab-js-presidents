...
function  countYearsInOffice(presidentsArr) {
  const totalYears = presidentsArr.reduce((total, currentPres) => {
    if (currentPres.leftOffice !== null) {
      return total + (currentPres.leftOffice - currentPres.tookOffice);
    }
    return total
  }, 0);
  return totalYears;
...
function sortPresidentsByBirthYear(presidentsArr) {
  return presidentsArr.sort((pres1, pres2) => pres1.birthYear - pres2.birthYear);
}
...
function sortPresidentsByName(presidentsArr) {
  return presidentsArr.sort((pres1, pres2) => {
